                ...
                <div className="flex items-center gap-2">
                    {canViewTeamStatus && (
                        <button
                            ...
                            title={showTeamStatus ? 'Hide Team Status' : 'Show Team Status'}
                            aria-label={showTeamStatus ? 'Hide Team Status' : 'Show Team Status'}
                            className="hidden lg:inline-flex items-center justify-center w-8 h-8 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                        >
                            <EyeIcon off={!showTeamStatus} />
                        </button>
                    )}
                    <RunningTime />
                </div>
