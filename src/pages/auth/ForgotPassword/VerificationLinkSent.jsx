...
function VerificationLinkSent({ submittedEmail }) {
    return (
        <div className="mt-8 space-y-6">
            <div className="text-center py-8">
                ...
                <p className="text-sm text-tertiary mb-4">
                    We&apos;ve sent a verification link to <span className="font-medium text-primary">{submittedEmail}</span>
                </p>
                <p className="text-sm text-tertiary mb-6">
                    Please check your email and click the link to verify your account. Once verified, you&apos;ll be able to reset your password.
                </p>
...
VerificationLinkSent.propTypes = {
